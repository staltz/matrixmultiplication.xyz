...
var index_1 = require("../Calculator/index");
...
function App(sources) {
    var calculatorSinks = index_1.default(sources);
    var vdom$ = view(calculatorSinks.DOM);
    var reducer$ = calculatorSinks.onion;
    var sinks = {
        DOM: vdom$,
        onion: reducer$,
    };
...
},{"../Calculator/index":3,"./styles":2,"@cycle/dom":48}],2:[function(require,module,exports){
"use strict";
...
var Styles;
(function (Styles) {
    Styles.title = typestyle_1.style({
        position: 'absolute',
        top: 0,
        left: 0,
        right: 0,
...
},{"../styles":35,"typestyle":148}],3:[function(require,module,exports){
"use strict";
...
var index_2 = require("./intent/index");
var index_3 = require("./model/index");
var index_4 = require("./view/index");
/**
...
function Calculator(sources) {
    ...
    var action$ = xstream_1.default.merge(index_2.default(sources.DOM), timers_1.default(state$));
    var reducer$ = index_3.default(action$, measurements$);
...
},{"../Matrix/index":25,"./intent/index":5,"./measure":7,"./model/index":10,"./timers":17,"./view/index":20,"@cycle/isolate":56,"xstream":157}],4:[function(require,module,exports){
"use strict";
var xstream_1 = require("xstream");
function controlPanelIntent(domSource) {
    var startMultiplyAction$ = domSource.select('.multiply').events('click')
...
},{"xstream":157}],5:[function(require,module,exports){
"use strict";
var xstream_1 = require("xstream");
...
function intent(domSource) {
    var resizeAction$ = resize_1.resizeIntent(domSource);
    var controlPanelAction$ = controlPanel_1.controlPanelIntent(domSource);
    return xstream_1.default.merge(resizeAction$, controlPanelAction$);
}
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = intent;

},{"./controlPanel":4,"./resize":6,"xstream":157}],6:[function(require,module,exports){
"use strict";
var xstream_1 = require("xstream");
...
function resizeIntent(domSource) {
    var decreaseRowA$ = domSource.select('.decreaseRowA').events('click')
        .mapTo(createResizeAction('A', 'row', -1));
    var increaseRowA$ = domSource.select('.increaseRowA').events('click')
        .mapTo(createResizeAction('A', 'row', +1));
    var decreaseColA$ = xstream_1.default
        .merge(domSource.select('.decreaseColA').events('click'), domSource.select('.decreaseRowB').events('click')).mapTo(createResizeAction('A', 'column', -1));
    var increaseColA$ = xstream_1.default
        .merge(domSource.select('.increaseColA').events('click'), domSource.select('.increaseRowB').events('click')).mapTo(createResizeAction('A', 'column', +1));
    var decreaseRowB$ = xstream_1.default
        .merge(domSource.select('.decreaseColA').events('click'), domSource.select('.decreaseRowB').events('click')).mapTo(createResizeAction('B', 'row', -1));
    var increaseRowB$ = xstream_1.default
        .merge(domSource.select('.increaseColA').events('click'), domSource.select('.increaseRowB').events('click')).mapTo(createResizeAction('B', 'row', +1));
    var decreaseColB$ = domSource.select('.decreaseColB').events('click')
        .mapTo(createResizeAction('B', 'column', -1));
    var increaseColB$ = domSource.select('.increaseColB').events('click')
        .mapTo(createResizeAction('B', 'column', +1));
...
},{"xstream":157}],7:[function(require,module,exports){
"use strict";
...
function measure(domSource) {
    return domSource.select('.calculator').elements()
        ...
        .filter(isNotNull)
        .compose(dropRepeats_1.default(function (m1, m2) {
        return m1.matrixAHeight === m2.matrixAHeight &&
...
},{"xstream/extra/delay":154,"xstream/extra/dropRepeats":155}],8:[function(require,module,exports){
"use strict";
/**
 ...
 */
function isResizeAction(ac) {
    return ac.type === 'RESIZE';
}
exports.isResizeAction = isResizeAction;
function isStartMultiplyAction(ac) {
    return ac.type === 'START_MULTIPLY';
}
exports.isStartMultiplyAction = isStartMultiplyAction;
function isNextStepAction(ac) {
    return ac.type === 'NEXT_STEP';
}
exports.isNextStepAction = isNextStepAction;
function isEndAction(ac) {
    return ac.type === 'END';
}
exports.isEndAction = isEndAction;
function isResetAction(ac) {
    return ac.type === 'RESET';
}
exports.isResetAction = isResetAction;
function isAllowContinueAction(ac) {
    return ac.type === 'ALLOW_CONTINUE';
}
exports.isAllowContinueAction = isAllowContinueAction;
...
exports.calculateNextMatrixC = calculateNextMatrixC;

},{}],10:[function(require,module,exports){
"use strict";
var xstream_1 = require("xstream");
var MatrixValues_1 = require("../../utils/MatrixValues");
var measure_1 = require("./reducers/measure");
var resize_1 = require("./reducers/resize");
var controlPanel_1 = require("./reducers/controlPanel");
var timers_1 = require("./reducers/timers");
var defaultState = {
    step: 0,
    canInteract: true,
 ...
 */
function model(action$, measurements$) {
...
},{"../../utils/MatrixValues":36,"./reducers/controlPanel":12,"./reducers/measure":13,"./reducers/resize":14,"./reducers/timers":15,"xstream":157}],11:[function(require,module,exports){
"use strict";
/**
 * This file contains some useful computed properties derivable from the state.
 */
function totalCombSteps(state) {
    return state.matrixA.values.numberRows + state.matrixB.values.numberColumns - 2;
}
exports.totalCombSteps = totalCombSteps;
function lastCombStep(state) {
    return 2 + totalCombSteps(state);
}
exports.lastCombStep = lastCombStep;
function isInCombStep(state) {
    return ((state.step === 1 && state.canInteract) || state.step > 1) &&
        state.step <= lastCombStep(state);
}
exports.isInCombStep = isInCombStep;
...
function startMultiplyReducer$(action$) {
    return action$
        ...
        .map(function (action) { return function startMultiplyReducer(prevState) {
        if (prevState.step === 0) {
            return {
                step: 1,
                canInteract: false,
                ...
                matrixC: {
                    editable: false,
                    values: MatrixValues_1.default.ofDimensions(prevState.matrixA.values.numberRows, prevState.matrixB.values.numberColumns).setAll(null),
                    id: 'C',
                }
            };
        }
...
exports.startMultiplyReducer$ = startMultiplyReducer$;
function nextStepReducer$(action$) {
    return action$
        .filter(actions_1.isNextStepAction)
        .map(function (action) { return function nextStepReducer(prevState) {
...
exports.nextStepReducer$ = nextStepReducer$;
function fastForwardToEndReducer$(action$) {
    return action$
        .filter(actions_1.isEndAction)
        .map(function (action) { return function fastForwardToEndReducer(prevState) {
        if (prevState.step >= 1 && prevState.canInteract && prevState.matrixC) {
            var nextStep = prevState.step + 1;
            return {
                step: nextStep,
...
exports.fastForwardToEndReducer$ = fastForwardToEndReducer$;
function resetReducer$(action$) {
    return action$
        .filter(actions_1.isResetAction)
        .map(function (action) { return function resetReducer(prevState) {
        return {
            step: 0,
            canInteract: true,
            fastForwardToEnd: false,
...
function updateMeasurementsReducer$(measurements$) {
    return measurements$
        .map(function (measurements) { return function (prevState) {
        return {
            step: prevState.step,
...
exports.updateMeasurementsReducer$ = updateMeasurementsReducer$;
...
function allowContinueReducer$(action$) {
    return action$
        .filter(actions_1.isAllowContinueAction)
        .map(function (action) { return function allowContinueReducer(prevState) {
...
exports.allowContinueReducer$ = allowContinueReducer$;

},{"../actions":8,"../calculate":9,"../queries":11}],16:[function(require,module,exports){
"use strict";
var typestyle_1 = require("typestyle");
var styles_1 = require("../Matrix/styles");
...
(function (Styles) {
     ...
     */
    Styles.matrixBracketWidth = styles_1.default.matrixBracketWidth;
    Styles.step1Duration1 = 600; // ms
    Styles.step1Duration2 = 900; // ms
    Styles.nextCombDuration = 500; // ms
    Styles.nextCombCellTransitionDelay = Styles.nextCombDuration * 0.5; // ms
    Styles.colorPallete = styles_2.pallete;
    Styles.cellScaleWhenIntersecting = 0.55;
    Styles.cellTranslateXWhenIntersecting = 16; // px
    ...
    Styles.matrixWrapperTable = typestyle_1.style({
        borderSpacing: 0,
    });
    Styles.matrixA = typestyle_1.style({
        position: 'relative',
    });
    Styles.matrixB = typestyle_1.style({
        transition: "opacity " + Styles.finalFadeDuration + "ms",
    });
    Styles.matrixC = typestyle_1.style({
        position: 'relative',
        transitionDuration: '700ms',
        transitionProperty: 'opacity, margin-left',
        transitionDelay: '300ms',
    });
    Styles.matrixCHidden = typestyle_1.style({
        position: 'relative',
        transitionDuration: '0ms',
        transitionProperty: 'opacity, margin-left',
        transitionDelay: '0ms',
    });
    Styles.resultEqualsSign = typestyle_1.style({
        fontSize: '24px',
    ...
    Styles.operatorCell = typestyle_1.style({
        transform: 'scale(0.6)',
     ...
     */
    Styles.controlPanel = typestyle_1.style({
        display: 'flex',
        alignItems: 'center',
        justifyContent: 'center',
        position: 'relative',
    ...
    var commonButtonDisabled = typestyle_1.style(commonButton, {
        backgroundColor: styles_2.pallete.gray,
    });
    ...
    Styles.multiplyOrEqualsSign = typestyle_1.style({
        margin: '1em',
        fontSize: '24px',
        color: styles_2.pallete.grayDark,
    });
     ...
     */
    Styles.rowsResizer = typestyle_1.style({
        display: 'flex',
    ...
    Styles.colsResizerContainer = typestyle_1.style({
        position: 'relative',
    });
    ...
    Styles.resizerButton = typestyle_1.style({
...
},{"../Matrix/styles":28,"../styles":35,"typestyle":148}],17:[function(require,module,exports){
"use strict";
var xstream_1 = require("xstream");
var delay_1 = require("xstream/extra/delay");
var dropRepeats_1 = require("xstream/extra/dropRepeats");
...
function timers(state$) {
    var stateChange$ = state$
        .compose(dropRepeats_1.default(function (s1, s2) {
        return s1.step === s2.step && s1.canInteract === s2.canInteract;
    }));
    var allowContinueFromStartMultiply$ = stateChange$
        .filter(function (state) { return state.step === 1 && !state.canInteract; })
        .compose(delay_1.default(styles_1.default.step1Duration1 + styles_1.default.step1Duration2))
        .mapTo({ type: 'ALLOW_CONTINUE', payload: null });
    var allowContinueFromNextComb$ = stateChange$
        .filter(function (state) { return queries_1.isInCombStep(state) && !state.canInteract; })
        .compose(delay_1.default(styles_1.default.nextCombDuration))
        .mapTo({ type: 'ALLOW_CONTINUE', payload: null });
    var allowContinueFromEnd$ = stateChange$
        .filter(function (state) { return state.step === queries_1.lastCombStep(state) + 1 && !state.canInteract; })
        .compose(delay_1.default(styles_1.default.finalResultDuration))
        .mapTo({ type: 'ALLOW_CONTINUE', payload: null });
    return xstream_1.default.merge(allowContinueFromStartMultiply$, allowContinueFromNextComb$, allowContinueFromEnd$);
}
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = timers;

},{"./model/queries":11,"./styles":16,"xstream":157,"xstream/extra/delay":154,"xstream/extra/dropRepeats":155}],18:[function(require,module,exports){
"use strict";
var dom_1 = require("@cycle/dom");
var styles_1 = require("../styles");
...
function renderRowsResizer(id) {
    return dom_1.div(".rowsResizer." + styles_1.default.rowsResizer, [
        dom_1.div(".decreaseRow" + id + "." + styles_1.default.resizerButton, '-'),
        dom_1.div(".increaseRow" + id + "." + styles_1.default.resizerButton, '+'),
    ]);
}
exports.renderRowsResizer = renderRowsResizer;
function renderColsResizer(id) {
    return dom_1.div(".colsResizer." + styles_1.default.colsResizer, [
        dom_1.div(".decreaseCol" + id + "." + styles_1.default.resizerButton, '-'),
        dom_1.div(".increaseCol" + id + "." + styles_1.default.resizerButton, '+'),
    ]);
}
exports.renderColsResizer = renderColsResizer;

},{"../styles":16,"@cycle/dom":48}],19:[function(require,module,exports){
"use strict";
var dom_1 = require("@cycle/dom");
var queries_1 = require("../model/queries");
var styles_1 = require("../styles");
...
var end_1 = require("../../icons/end");
var reset_1 = require("../../icons/reset");
function getArrayOfButtons(state) {
    var step = state.step;
    var buttons = [];
    if (step === 0) {
        buttons = [
            dom_1.div(".multiply." + styles_1.default.multiplyButton, [play_1.default, 'Multiply'])
        ];
    }
    else if (step === 1 && !state.canInteract) {
        buttons = [
            dom_1.div(".multiply." + styles_1.default.multiplyButtonDisabled, [play_1.default, 'Multiply'])
        ];
    }
    else if (step >= 1 && step <= queries_1.lastCombStep(state) && state.canInteract) {
        buttons = [
            dom_1.div(".next." + styles_1.default.nextButton, [next_1.default, 'Next']),
            dom_1.div(".end." + styles_1.default.endButton, [end_1.default, 'End']),
        ];
    }
    else if (step >= 1 && step <= queries_1.lastCombStep(state) + 1 && !state.canInteract) {
        buttons = [
            dom_1.div(".next." + styles_1.default.nextButtonDisabled, [next_1.default, 'Next']),
            dom_1.div(".end." + styles_1.default.endButtonDisabled, [end_1.default, 'End']),
        ];
    }
    else if (step === queries_1.lastCombStep(state) + 1 && state.canInteract) {
        buttons = [
            dom_1.div(".reset." + styles_1.default.resetButton, [reset_1.default, 'Reset']),
        ];
    }
    return buttons;
}
function renderControlPanel(state) {
    return dom_1.div(".controlPanel." + styles_1.default.controlPanel, getArrayOfButtons(state));
}
exports.renderControlPanel = renderControlPanel;

},{"../../icons/end":30,"../../icons/next":31,"../../icons/play":32,"../../icons/reset":33,"../model/queries":11,"../styles":16,"@cycle/dom":48}],20:[function(require,module,exports){
"use strict";
var xstream_1 = require("xstream");
var dom_1 = require("@cycle/dom");
var queries_1 = require("../model/queries");
var styles_1 = require("../styles");
var matrixA_1 = require("./matrixA");
var matrixB_1 = require("./matrixB");
var matrixC_1 = require("./matrixC");
var controlPanel_1 = require("./controlPanel");
var common_1 = require("./common");
var tweens_1 = require("./tweens");
function renderSign(state) {
    if (queries_1.isInCombStep(state)) {
        return dom_1.span(".multiplySign." + styles_1.default.multiplyOrEqualsSign, '=');
    }
    else {
        return dom_1.span(".tempEqualsSign." + styles_1.default.multiplyOrEqualsSign, common_1.multiplySign);
    }
}
function maybeRenderEqualsSign(state) {
    var style = {};
    if (state.step === queries_1.lastCombStep(state) + 1) {
    ...
    return dom_1.span(".resultEqualsSign." + styles_1.default.resultEqualsSign, { style: style }, '=');
}
/**
 * Creates a visual representation ("VNode") of the state.
 * Includes also the visual representations of child matrices.
 */
function view(state$, vdomA$, vdomB$, vdomC$) {
    var transform$ = tweens_1.makeTransform$(state$);
    return xstream_1.default.combine(state$, transform$, vdomA$, vdomB$, vdomC$.startWith(null))
        .map(function (_a) {
        var state = _a[0], transform = _a[1], matrixA = _a[2], matrixB = _a[3], matrixC = _a[4];
        return dom_1.div(".calculator." + styles_1.default.calculator, [
            dom_1.div(".matrices." + styles_1.default.matrices, [
                matrixA_1.renderMatrixA(matrixA, state),
                renderSign(state),
                matrixB_1.renderMatrixB(matrixB, state, transform),
                maybeRenderEqualsSign(state),
                matrixC_1.maybeRenderMatrixC(matrixC, state),
            ]),
            controlPanel_1.renderControlPanel(state),
        ]);
    });
}
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../model/queries":11,"../styles":16,"./common":18,"./controlPanel":19,"./matrixA":21,"./matrixB":22,"./matrixC":23,"./tweens":24,"@cycle/dom":48,"xstream":157}],21:[function(require,module,exports){
"use strict";
var dom_1 = require("@cycle/dom");
var queries_1 = require("../model/queries");
var styles_1 = require("../../Matrix/styles");
var styles_2 = require("../styles");
var common_1 = require("./common");
function renderOperatorGrid(state) {
    if (state.step === 0) {
        return null;
    }
            ...
            return dom_1.li([
                dom_1.span('.operator', {
                    class: (_a = {},
                        ...
                        _a[styles_2.default.operatorCell] = true,
                        _a[styles_2.default.plusSign] = shouldShowPlus,
                        _a),
                    style: { opacity: shouldShowMultiply ? 1 : 0.01 }
                }, [common_1.multiplySign])
            ]);
            var _a;
        }));
    }));
...
function mutateCellStyles(state) {
    ...
    return function updateHook(prev, next) {
        ...
        var _loop_1 = function (i, N) {
            ...
            var rowOfCell = parseInt(cellElem.dataset.row);
            if (queries_1.isInCombStep(state)) {
                cellElem.classList.add(styles_2.default.animatedCell);
            }
...
function renderMatrixA(matrixA, state) {
    var showResizers = state.step === 0;
    return dom_1.table(".matrixAWrapper." + styles_2.default.matrixWrapperTable, [
        dom_1.tr([
            dom_1.td(showResizers ? [common_1.renderRowsResizer('A')] : []),
            dom_1.td(".matrixA." + styles_2.default.matrixA, {
                hook: { update: mutateCellStyles(state) }
            }, [matrixA, renderOperatorGrid(state)]),
        ]),
        dom_1.tr([
            dom_1.td(),
            dom_1.td(".colsResizerContainer." + styles_2.default.colsResizerContainer, showResizers ? [common_1.renderColsResizer('A')] : []),
        ]),
    ]);
}
exports.renderMatrixA = renderMatrixA;

},{"../../Matrix/styles":28,"../model/queries":11,"../styles":16,"./common":18,"@cycle/dom":48}],22:[function(require,module,exports){
"use strict";
var dom_1 = require("@cycle/dom");
var queries_1 = require("../model/queries");
var styles_1 = require("../styles");
...
function getOpacity(state) {
    if (state.step === queries_1.lastCombStep(state) + 1 && !state.canInteract) {
        return '0.01';
    }
    else if (state.step === queries_1.lastCombStep(state) + 1 && state.canInteract) {
        return '1';
    }
    else {
        return '1';
...
function mutateCellStyles(state, transform) {
    var lastIntersectCol = state.step - 2;
    var firstIntersectCol = state.step - 2 - state.matrixA.values.numberRows;
    var rotateZTransform = transform // string
        .split(' ') // Array<string>
...
function renderMatrixB(matrixB, state, transform) {
    var showResizers = state.step === 0;
    var opacity = getOpacity(state);
    return dom_1.table(".matrixBWrapper." + styles_1.default.matrixWrapperTable, [
        dom_1.tr([
            dom_1.td(".matrixB." + styles_1.default.matrixB, {
                style: { opacity: opacity, transform: transform, transformOrigin: 'bottom left' },
                hook: { update: mutateCellStyles(state, transform) },
            }, [matrixB]),
            dom_1.td(showResizers ? [common_1.renderRowsResizer('B')] : []),
        ]),
        dom_1.tr([
            dom_1.td(".colsResizerContainer." + styles_1.default.colsResizerContainer, showResizers ? [common_1.renderColsResizer('B')] : []),
            dom_1.td(),
        ]),
    ]);
}
...
},{"../model/queries":11,"../styles":16,"./common":18,"@cycle/dom":48}],23:[function(require,module,exports){
"use strict";
var dom_1 = require("@cycle/dom");
var queries_1 = require("../model/queries");
var styles_1 = require("../styles");
...
function maybeRenderMatrixC(matrixC, state) {
    var step = state.step;
    if (matrixC === null || step === 0 || (step === 1 && !state.canInteract)) {
        return dom_1.div('.matrixC', {
            class: (_a = {}, _a[styles_1.default.matrixCHidden] = true, _a),
        ...
        var xDist = state.measurements.matrixBWidth + 8;
        var yDist = state.measurements.matrixAHeight * 0.5;
        return dom_1.div('.matrixC', {
            class: (_b = {}, _b[styles_1.default.matrixC] = true, _b),
            style: {
                transform: "translateX(-" + xDist + "px) translateY(-" + yDist + "px)",
                opacity: '1',
                marginLeft: step === queries_1.lastCombStep(state) + 1 ? xDist + "px" : '0',
            },
            hook: {
...
},{"../model/queries":11,"../styles":16,"@cycle/dom":48}],24:[function(require,module,exports){
"use strict";
var xstream_1 = require("xstream");
var concat_1 = require("xstream/extra/concat");
var delay_1 = require("xstream/extra/delay");
var tween_1 = require("xstream/extra/tween");
var dropRepeats_1 = require("xstream/extra/dropRepeats");
var queries_1 = require("../model/queries");
var styles_1 = require("../styles");
var xMove = 59.5; // px
var padding = 8; // px
function makeStartMultiplyTransform$(state$) {
    return state$
        .filter(function (state) { return state.step === 1; })
        .map(function (state) {
        var ease = tween_1.default.power2.easeInOut;
        var yLift = padding +
            state.measurements.matrixAHeight * 0.5 +
            state.measurements.matrixBHeight * 0.5;
        return concat_1.default(tween_1.default({ from: 0, to: yLift, duration: styles_1.default.step1Duration1, ease: ease })
            .map(function (y) { return "\n            translateX(0%)\n            translateY(" + -y + "px)\n            rotateZ(0deg)\n          "; }), tween_1.default({ from: 0, to: 1, duration: styles_1.default.step1Duration2, ease: ease })
            .map(function (t) { return "\n            translateX(" + -t * xMove + "px)\n            translateY(" + -yLift + "px)\n            rotateZ(" + -Math.pow(t, 2.3) * 90 + "deg)\n          "; }));
    })
        .flatten();
}
function makeNextStepTransform$(state$) {
    return state$
        .filter(function (state) { return state.step > 1 && state.step <= queries_1.lastCombStep(state); })
        .map(function (state) {
        var ease = tween_1.default.power2.easeInOut;
        var duration = styles_1.default.nextCombDuration;
        var yLift = padding +
            state.measurements.matrixAHeight * 0.5 +
            state.measurements.matrixBHeight * 0.5;
        var yPrev = state.step === 2 ? yLift : yLift -
            padding -
            styles_1.default.matrixBracketWidth * 2 -
            state.measurements.rowHeight * (state.step - 2);
        var yNext = yLift -
            padding -
            styles_1.default.matrixBracketWidth * 2 -
            state.measurements.rowHeight * (state.step - 1);
        return tween_1.default({ from: yPrev, to: yNext, duration: duration, ease: ease }).map(function (y) { return "\n        translateX(" + -xMove + "px)\n        translateY(" + -y + "px)\n        rotateZ(-90deg)\n      "; });
    })
        .flatten();
}
function makeEndTransform$(state$) {
    return state$
        .filter(function (state) { return state.step === queries_1.lastCombStep(state) + 1; })
        .map(function (state) {
        var ease = tween_1.default.power2.easeInOut;
        var duration = styles_1.default.finalFadeDuration;
        var timeToReset = styles_1.default.finalResultDuration - duration;
        var yLift = padding +
            state.measurements.matrixAHeight * 0.5 +
            state.measurements.matrixBHeight * 0.5;
        var yLastComb = yLift -
            ...
            styles_1.default.matrixBracketWidth * 2 -
            state.measurements.rowHeight * (state.step - 2);
        var yOutside = yLastComb -
            state.measurements.rowHeight -
            padding * 4;
        return concat_1.default(tween_1.default({ from: yLastComb, to: yOutside, duration: duration, ease: ease }).map(function (y) { return "\n          translateX(" + -xMove + "px)\n          translateY(" + -y + "px)\n          rotateZ(-90deg)\n        "; }), xstream_1.default.of('translateX(0px) translateY(0px) rotateZ(0deg)')
            .compose(delay_1.default(timeToReset * 0.9)));
    })
        .flatten();
}
/**
 ...
 */
function makeTransform$(state$) {
    var stateOnStepChange$ = state$
        .compose(dropRepeats_1.default(function (s1, s2) { return s1.step === s2.step; }));
    return xstream_1.default.merge(makeStartMultiplyTransform$(stateOnStepChange$), makeNextStepTransform$(stateOnStepChange$), makeEndTransform$(stateOnStepChange$)).startWith('translateX(0%) translateY(0px) rotateZ(0deg)');
}
exports.makeTransform$ = makeTransform$;

},{"../model/queries":11,"../styles":16,"xstream":157,"xstream/extra/concat":153,"xstream/extra/delay":154,"xstream/extra/dropRepeats":155,"xstream/extra/tween":156}],25:[function(require,module,exports){
"use strict";
...
function Matrix(sources) {
    var action$ = intent_1.default(sources.DOM);
    var reducer$ = model_1.default(action$);
    var vdom$ = view_1.default(sources.onion.state$);
    var sinks = {
        DOM: vdom$,
        onion: reducer$,
    };
...
},{"./intent":26,"./model":27,"./view":29}],26:[function(require,module,exports){
"use strict";
/**
 * Interprets user events as actions that can affect the state in the model.
 */
function intent(domSource) {
    return domSource.select('.cell').events('input')
        ...
        .filter(function (action) { return !isNaN(action.val); });
}
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = intent;
...
},{"../utils/MatrixValues":36,"xstream":157}],28:[function(require,module,exports){
"use strict";
var typestyle_1 = require("typestyle");
var styles_1 = require("../styles");
var Styles;
(function (Styles) {
    ...
    Styles.matrixBracketWidthPx = Styles.matrixBracketWidth + "px";
    Styles.matrixBracketIngress = '9px';
    Styles.matrixBracketColor = styles_1.pallete.black;
    /**
     * Styles for the matrix and its brackets.
     */
    Styles.matrix = typestyle_1.style({
        position: 'relative',
        padding: Styles.matrixBracketWidth,
    });
    Styles.leftBracket = typestyle_1.style({
        position: 'absolute',
        left: 0,
        bottom: 0,
        top: 0,
...
},{"../styles":35,"typestyle":148}],29:[function(require,module,exports){
"use strict";
var dom_1 = require("@cycle/dom");
var styles_1 = require("./styles");
var zeroWidthSpace = '\u200B';
function renderLeftBracket(state) {
    return dom_1.div(".leftBracket." + styles_1.default.leftBracket, {
        key: "leftBracket" + state.id,
    });
}
function renderRightBracket(state) {
    return dom_1.div(".rightBracket." + styles_1.default.rightBracket, {
...
function view(state$) {
    return state$.map(function (state) {
        return dom_1.div(".matrix." + styles_1.default.matrix, { key: state.id }, [
            renderLeftBracket(state)
        ].concat(renderAllCells(state), [
...
},{"./styles":28,"@cycle/dom":48}],30:[function(require,module,exports){
"use strict";
var dom_1 = require("@cycle/dom");
var endIcon = dom_1.svg({
    attrs: {
        width: '20px',
        height: '20px',
...
},{"@cycle/dom":48}],31:[function(require,module,exports){
"use strict";
var dom_1 = require("@cycle/dom");
var nextIcon = dom_1.svg({
    attrs: {
        width: '20px',
        height: '20px',
...
},{"@cycle/dom":48}],32:[function(require,module,exports){
"use strict";
var dom_1 = require("@cycle/dom");
var playIcon = dom_1.svg({
    attrs: {
        width: '20px',
        height: '20px',
...
},{"@cycle/dom":48}],33:[function(require,module,exports){
"use strict";
var dom_1 = require("@cycle/dom");
var resetIcon = dom_1.svg({
    attrs: {
        width: '20px',
        height: '20px',
...
},{"@cycle/dom":48}],34:[function(require,module,exports){
"use strict";
...
},{"./App/index":1,"./styles":35,"@cycle/dom":48,"@cycle/run":58,"cycle-onionify":60,"typestyle":148}],35:[function(require,module,exports){
"use strict";
var typestyle_1 = require("typestyle");
...
},{"typestyle":148}],36:[function(require,module,exports){
"use strict";
...
var MatrixValues = (function () {
    ...
    MatrixValues.from = function (vals) {
        var mv = new MatrixValues();
        mv.numRows = vals.length;
        mv.numCols = vals[0].length;
        mv.values = immutable_1.fromJS(vals);
        return mv;
    };
    MatrixValues.prototype.resize = function (numRows, numColumns) {
        var _a = this, oldNumRows = _a.numRows, oldNumCols = _a.numCols;
        var nR = Math.max(1, numRows);
        var nC = Math.max(1, numColumns);
        ...
        mv.values = this.values
            ...
            if (rowIndex >= oldNumRows) {
                ...
                return rows.setSize(nC).map(function (v, colIndex) {
                    return colIndex >= oldNumCols ? 1 : v;
                });
            }
        });
        return mv;
    };
    MatrixValues.prototype.set = function (rowIndex, colIndex, value) {
        var mv = this.clone();
        mv.values = mv.values.setIn([rowIndex, colIndex], value);
        return mv;
    };
    MatrixValues.prototype.get = function (rowIndex, colIndex) {
        return this.values.getIn([rowIndex, colIndex]);
    };
    MatrixValues.prototype.setAll = function (value) {
        var mv = new MatrixValues();
        mv.numRows = this.numRows;
        mv.numCols = this.numCols;
    ...
    Object.defineProperty(MatrixValues.prototype, "numberColumns", {
        get: function () {
            return this.numCols;
        },
        enumerable: true,
    ...
    Object.defineProperty(MatrixValues.prototype, "rows", {
        get: function () {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = MatrixValues;
function makeValues(numRows, numColumns, val) {
    if (val === void 0) { val = 1; }
    var vals = new Array(numRows);
    for (var i = 0; i < numRows; i++) {
        vals[i] = makeRow(numColumns, val);
    }
    return immutable_1.List(vals);
}
function makeRow(numColumns, val) {
    if (val === void 0) { val = 1; }
...
},{"immutable":115}],37:[function(require,module,exports){
"use strict";
var xstream_1 = require("xstream");
...
},{"./fromEvent":46,"@cycle/run/lib/adapt":57,"xstream":157}],38:[function(require,module,exports){
"use strict";
var xstream_1 = require("xstream");
var adapt_1 = require("@cycle/run/lib/adapt");
var fromEvent_1 = require("./fromEvent");
...
},{"./fromEvent":46,"@cycle/run/lib/adapt":57,"xstream":157}],39:[function(require,module,exports){
"use strict";
...
},{"./ScopeChecker":44,"./matchesSelector":52,"./utils":55}],40:[function(require,module,exports){
"use strict";
var xstream_1 = require("xstream");
var ScopeChecker_1 = require("./ScopeChecker");
var utils_1 = require("./utils");
...
},{"./ScopeChecker":44,"./matchesSelector":52,"./utils":55,"xstream":157}],41:[function(require,module,exports){
"use strict";
var xstream_1 = require("xstream");
var adapt_1 = require("@cycle/run/lib/adapt");
...
},{"@cycle/run/lib/adapt":57,"xstream":157}],42:[function(require,module,exports){
"use strict";
...
},{"es6-map":102}],43:[function(require,module,exports){
"use strict";
var adapt_1 = require("@cycle/run/lib/adapt");
...
},{"./BodyDOMSource":37,"./DocumentDOMSource":38,"./ElementFinder":39,"./EventDelegator":40,"./fromEvent":46,"./isolate":49,"./utils":55,"@cycle/run/lib/adapt":57}],44:[function(require,module,exports){
"use strict";
...
},{"snabbdom-selector/lib/commonjs/classNameFromVNode":124,"snabbdom-selector/lib/commonjs/selectorParser":125,"snabbdom/h":133}],46:[function(require,module,exports){
"use strict";
var xstream_1 = require("xstream");
...
},{"xstream":157}],47:[function(require,module,exports){
"use strict";
var h_1 = require("snabbdom/h");
...
},{"snabbdom/h":133}],48:[function(require,module,exports){
"use strict";
...
},{"./HTMLSource":41,"./MainDOMSource":43,"./hyperscript-helpers":47,"./makeDOMDriver":50,"./makeHTMLDriver":51,"./mockDOMSource":53,"snabbdom/h":133,"snabbdom/thunk":142}],49:[function(require,module,exports){
"use strict";
var utils_1 = require("./utils");
...
},{"./IsolateModule":42,"./MainDOMSource":43,"./VNodeWrapper":45,"./modules":54,"./utils":55,"es6-map":102,"snabbdom":141,"snabbdom/tovnode":143,"xstream":157}],51:[function(require,module,exports){
"use strict";
var HTMLSource_1 = require("./HTMLSource");
...
},{"./HTMLSource":41,"snabbdom-to-html/init":127,"snabbdom-to-html/modules":130}],52:[function(require,module,exports){
"use strict";
...
},{"@cycle/run/lib/adapt":57,"xstream":157}],54:[function(require,module,exports){
"use strict";
...
},{"snabbdom/modules/attributes":136,"snabbdom/modules/class":137,"snabbdom/modules/dataset":138,"snabbdom/modules/props":139,"snabbdom/modules/style":140}],55:[function(require,module,exports){
"use strict";
...
},{"./adapt":57,"xstream":157}],59:[function(require,module,exports){
/*!
...
function pick(selector) {
    if (typeof selector === 'string') {
        return function pickWithString(sinksArray$) {
            return sinksArray$.map(function (sinksArray) { return sinksArray.map(function (sinks) { return sinks[selector]; }); });
        };
    }
    else {
        return function pickWithFunction(sinksArray$) {
            return sinksArray$.map(function (sinksArray) { return sinksArray.map(selector); });
        };
    }
}
exports.pick = pick;
...
function updateArrayEntry(array, index, reducer) {
    var newVal = reducer(array[index]);
...
exports.isolateSource = isolateSource;
function isolateSink(reducer$, scope) {
    return reducer$.map(function (reducer) { return function (state) {
        var index = parseInt(scope);
        if (Array.isArray(state) && typeof index === 'number') {
            return updateArrayEntry(state, index, reducer);
        }
        else if (typeof state === 'undefined') {
            return _a = {}, _a[scope] = reducer(void 0), _a;
        }
        else {
            var prevPiece = state[scope];
            var nextPiece = reducer(prevPiece);
            if (prevPiece === nextPiece) {
                return state;
            }
            else {
                return Object.assign({}, state, (_b = {}, _b[scope] = nextPiece, _b));
            }
        }
        var _a, _b;
    }; });
...
var StateSource = (function () {
    ...
    StateSource.prototype.select = function (scope) {
        return new StateSource(this.state$.map(function (s) { return s[scope]; }).filter(function (s) { return typeof s !== 'undefined'; }), null);
    };
    return StateSource;
}());
...
},{"xstream":157,"xstream/extra/dropRepeats":155}],61:[function(require,module,exports){
'use strict';
...
},{"es5-ext/object/copy":75,"es5-ext/object/map":83,"es5-ext/object/valid-callable":89,"es5-ext/object/valid-value":90}],62:[function(require,module,exports){
'use strict';
...
},{"es5-ext/object/assign":72,"es5-ext/object/is-callable":78,"es5-ext/object/normalize-options":84,"es5-ext/string/#/contains":91}],63:[function(require,module,exports){
...
},{"../../object/valid-value":90}],64:[function(require,module,exports){
'use strict';
...
},{"../../number/to-pos-integer":70,"../../object/valid-value":90}],65:[function(require,module,exports){
'use strict';
...
},{"../math/sign":66}],70:[function(require,module,exports){
'use strict';
...
},{"./valid-callable":89,"./valid-value":90}],72:[function(require,module,exports){
'use strict';
...
},{"../keys":80,"../valid-value":90}],75:[function(require,module,exports){
'use strict';
...
},{"./assign":72,"./valid-value":90}],76:[function(require,module,exports){
...
},{"./set-prototype-of/is-implemented":87,"./set-prototype-of/shim":88}],77:[function(require,module,exports){
'use strict';

module.exports = require('./_iterate')('forEach');

},{"./_iterate":71}],78:[function(require,module,exports){
// Deprecated
...
},{"./for-each":77,"./valid-callable":89}],84:[function(require,module,exports){
'use strict';
...
},{"../create":76,"../is-object":79,"../valid-value":90}],89:[function(require,module,exports){
'use strict';
...
},{"./":98,"d":62,"es5-ext/object/set-prototype-of":86,"es5-ext/string/#/contains":91}],96:[function(require,module,exports){
'use strict';
...
},{"./get":97,"es5-ext/function/is-arguments":65,"es5-ext/object/valid-callable":89,"es5-ext/string/is-string":94}],97:[function(require,module,exports){
'use strict';
...
},{"./array":95,"./string":100,"./valid-iterable":101,"es5-ext/function/is-arguments":65,"es5-ext/string/is-string":94,"es6-symbol":108}],98:[function(require,module,exports){
'use strict';
...
},{"d":62,"d/auto-bind":61,"es5-ext/array/#/clear":63,"es5-ext/object/assign":72,"es5-ext/object/valid-callable":89,"es5-ext/object/valid-value":90,"es6-symbol":108}],99:[function(require,module,exports){
'use strict';
...
},{"es5-ext/function/is-arguments":65,"es5-ext/string/is-string":94,"es6-symbol":108}],100:[function(require,module,exports){
...
},{"./":98,"d":62,"es5-ext/object/set-prototype-of":86}],101:[function(require,module,exports){
'use strict';
...
},{"./is-iterable":99}],102:[function(require,module,exports){
'use strict';

module.exports = require('./is-implemented')() ? Map : require('./polyfill');

},{"./is-implemented":103,"./polyfill":107}],103:[function(require,module,exports){
'use strict';
...
},{"es5-ext/object/primitive-set":85}],106:[function(require,module,exports){
'use strict';
...
},{"./iterator-kinds":105,"d":62,"es5-ext/object/set-prototype-of":86,"es6-iterator":98,"es6-symbol":108}],107:[function(require,module,exports){
'use strict';
...
},{"./is-native-implemented":104,"./lib/iterator":106,"d":62,"es5-ext/array/#/clear":63,"es5-ext/array/#/e-index-of":64,"es5-ext/object/set-prototype-of":86,"es5-ext/object/valid-callable":89,"es5-ext/object/valid-value":90,"es6-iterator/for-of":96,"es6-iterator/valid-iterable":101,"es6-symbol":108,"event-emitter":113}],108:[function(require,module,exports){
'use strict';

module.exports = require('./is-implemented')() ? Symbol : require('./polyfill');

},{"./is-implemented":109,"./polyfill":111}],109:[function(require,module,exports){
'use strict';
...
},{"./validate-symbol":112,"d":62}],112:[function(require,module,exports){
'use strict';
...
},{"./is-symbol":110}],113:[function(require,module,exports){
'use strict';
...
},{"d":62,"es5-ext/object/valid-callable":89}],114:[function(require,module,exports){
(function (process){
"use strict";
...
},{"_process":123}],115:[function(require,module,exports){
/**
...
},{"browser-split":59}],123:[function(require,module,exports){
...
},{"./elements":126,"parse-sel":122}],128:[function(require,module,exports){
...
},{"lodash.escape":116,"lodash.forown":117}],129:[function(require,module,exports){
...
},{"lodash.forown":117,"lodash.remove":119,"lodash.uniq":120}],130:[function(require,module,exports){
...
},{"./attributes":128,"./class":129,"./props":131,"./style":132}],131:[function(require,module,exports){
...
},{"lodash.escape":116,"lodash.forown":117}],132:[function(require,module,exports){
...
},{"lodash.escape":116,"lodash.forown":117,"lodash.kebabcase":118,"object-assign":121}],133:[function(require,module,exports){
"use strict";
...
},{"./is":135,"./vnode":144}],134:[function(require,module,exports){
"use strict";
...
},{"./h":133,"./htmldomapi":134,"./is":135,"./thunk":142,"./vnode":144}],142:[function(require,module,exports){
"use strict";
var h_1 = require("./h");
...
},{"./h":133}],143:[function(require,module,exports){
"use strict";
var vnode_1 = require("./vnode");
var htmldomapi_1 = require("./htmldomapi");
...
},{"./htmldomapi":134,"./vnode":144}],144:[function(require,module,exports){
"use strict";
...
},{"./lib/index":146}],146:[function(require,module,exports){
(function (global){
'use strict';
...
},{"./ponyfill":147}],147:[function(require,module,exports){
'use strict';
...
},{"./internal/typestyle":150,"./internal/utilities":151,"./types":152}],149:[function(require,module,exports){
"use strict";
...
},{"free-style":114}],150:[function(require,module,exports){
"use strict";
...
},{"./formatting":149,"./utilities":151,"free-style":114}],151:[function(require,module,exports){
"use strict";
...
},{"../index":157}],154:[function(require,module,exports){
"use strict";
var index_1 = require("../index");
...
},{"../index":157}],155:[function(require,module,exports){
"use strict";
var index_1 = require("../index");
var empty = {};
...
},{"../index":157}],156:[function(require,module,exports){
"use strict";
var index_1 = require("../index");
...
},{"../index":157,"./concat":153}],157:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
